...
public class SettingsActivity extends AppCompatActivity {
    ...
    //private String statusMusicSwitch,
    private String statusSoundsSwitch;
    ...
    public void onBackPressed() {
        ...
        if (soundsOnOff != soundsSwitch.isChecked()) {
    ...
    public void loadData() {
        ...
        soundsOnOff = sharedPreferences.getBoolean(SWITCH_SOUNDS, true);
    }
